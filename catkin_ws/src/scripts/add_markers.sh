...
sleep 3
xterm -e "source devel/setup.bash; roslaunch home_service_robot add_marker_object_rviz.launch" &
sleep 3
xterm -e "source devel/setup.bash; rosrun add_markers pick_drop_marker"
